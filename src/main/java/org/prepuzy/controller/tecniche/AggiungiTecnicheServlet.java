...
@WebServlet("/master/AggiungiTecnicheServlet")
public class AggiungiTecnicheServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/private_jsp/AggiungiTecniche.jsp").forward(request, response);
	}
