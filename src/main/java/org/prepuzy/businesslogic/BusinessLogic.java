...
public class BusinessLogic {
    ...
    public static Equipaggiamento equipByNaveId(long id) {
	return DaoFactory.getInstance(DATABASE).getJpaDaoEquipaggiamento().equipByIdNave(id);
    }

    public static void modificaEquipaggiamentoPersonaggio(Equipaggiamento equip, Personaggio personaggio,
	    Oggetto oggetto) {
    ...
    public static Inventario trovaInvenatrioById(long id) {
	return DaoFactory.getInstance(DATABASE).getJpaDaoInventario().selectById(id);
    }
    ...
    public static Inventario inventarioByPersonaggioId(long id) {
	return DaoFactory.getInstance(DATABASE).getJpaDaoInventario().selectByPersonaggioId(id);
    }

    public static Inventario inventariobyNaveId(long id) {
	return DaoFactory.getInstance(DATABASE).getJpaDaoInventario().selectByNaveId(id);
    }

    public static void modificaInventario(Inventario i) {
	DaoFactory.getInstance(DATABASE).getJpaDaoInventario().update(i);
    }
	...
	return DaoFactory.getInstance(DATABASE).getJpaDaoPersonaggio().listaPersonaggiConTaglia();
    }
