...
<title>Modifica Abilità Frutto</title>
...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form action="${pageContext.request.contextPath}/master/ModificaAbilitaFruttoServlet" method="post">
