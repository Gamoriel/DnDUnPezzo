...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form
				action="${pageContext.request.contextPath}/master/ModificaNaveServlet"
				method="post">

				<input type="hidden" name="idNave" value="<%=nave.getId()%>">

				<label for="nome">Nome Nave:</label> <input type="text" name="nome"
					value="<%=nave.getNome()%>" required><br> <br> <label
				...
				<br> <label for="hp">HP:</label> <input type="number" name="hp"
					value="<%=nave.getHp()%>" required><br> <label
					for="hp">Classe Armatura:</label> <input type="number"
					name="classeArmatura" value="<%=nave.getClasseArmatura()%>"
					required><br> <label for="ciurma">Ciurma:</label> <select
					name="ciurma" required>
				...
				<div class="upload-container">
					<label for="imgNave" class="upload-label">Carica Immagine:</label>
					<input type="file" id="imgNave" name="imgNave" accept="image/*"
