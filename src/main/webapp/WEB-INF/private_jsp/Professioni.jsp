...
<body>
	<nav>
		<div class="addNew">
			<form action="${pageContext.request.contextPath}/master/AggiungiProfessioneServlet" method="get">
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<div class="cardContainerNoImg">
				<%
				List<Professione> listaProfessioni = (List<Professione>) request.getAttribute("professioni");
				...
				<div class="listCard">
					...
					<div class="formContainer">
						<form action="${pageContext.request.contextPath}/DettagliProfessioneServlet" method="get">
