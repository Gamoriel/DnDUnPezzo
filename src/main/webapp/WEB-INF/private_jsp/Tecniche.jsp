...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			<h1>Lista Tecniche</h1>
			<div class="cardContainerNoImg">
				<%
				List<Tecniche> tecniche = (List<Tecniche>) request.getAttribute("listaTecniche");
				if (tecniche != null && !tecniche.isEmpty()) {
					for (Tecniche t : tecniche) {
				%>
				<div class="listCard">
					<h2><%=t.getNome()%></h2>
				...
				%>
				<p>Nessuna Tecnica disponibile</p>
				<%
				}
				%>
			</div>
