...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form action="${pageContext.request.contextPath}/master/ModificaTecnicheServlet" method="post">
				<input type="hidden" name="idTecnica" value="<%=t.getId()%>">

				<label for="nome">Nome Abilità:</label> <input type="text"
					name="nome" value="<%=t.getNome()%>" required><br>
				<br> <label for="descrizione">Descrizione:</label>
				<textarea name="descrizione" rows="4" cols="50" required><%=t.getDescrizione()%></textarea>
				<br>
				<br>
