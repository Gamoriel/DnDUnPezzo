...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			<h1>Aggiungi Nuova Razza</h1>

			<form action="${pageContext.request.contextPath}/master/AggiungiRazzaServlet" method="post">
				...
				<div><input type="submit" value="Aggiungi Razza"></div>
		</form>
	</div>
</div>
</body>
