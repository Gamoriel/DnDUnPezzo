...
<body>
	<nav>
		<div class="addNew">
			<form action="${pageContext.request.contextPath}/master/AggiungiQualitaServlet" method="get">
			...
			<div class="cardContainerNoImg">
				...
				<div class="listCard">
					...
					<div class="formContainer">
						<form action="${pageContext.request.contextPath}/master/EliminaQualitaServlet" method="post"><input type="hidden" name="idQualita" value="<%=qualita.getId()%>">
							<button class="buttonMod" type="submit">Elimina Qualità</button></form>
				</div>
			</div> <%
				}
				} else {
