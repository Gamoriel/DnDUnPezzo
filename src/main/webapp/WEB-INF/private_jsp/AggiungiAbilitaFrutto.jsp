	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form action="${pageContext.request.contextPath}/master/AggiungiAbilitaFruttoServlet" method="post">
				<div class="formGroup"><label for="nome">Nome:</label> <input type="text" id="nome" name="nome" required><br></div>
				<div class="formGroup"><label for="descrizione">Descrizione:</label> <textarea id="descrizione" name="descrizione" required></textarea> <br></div>
