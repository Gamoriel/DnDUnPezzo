...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			<h1>Elenco Taglie Personaggi</h1>
				...
				<div class="listCard" style="--bg-image: url('<%=pageContext.getServletContext().getContextPath() + "/" + personaggio.getUrlImmagine().get(0)%>')">
					...
					<div class="listCard" style="background-color: black">
						...
						<div class="formContainer">
							<form action="${pageContext.request.contextPath}/TagliaPersonaggioServlet" method="get"><input type="hidden" name="idPersonaggio" value="<%=personaggio.getId()%>">
								<button class="buttonMod" type="submit">Dettagli</button></form>
					</div>
				</div> <%
 }
 } else {
