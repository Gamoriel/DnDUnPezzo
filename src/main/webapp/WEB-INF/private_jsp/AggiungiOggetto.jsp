...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form action="${pageContext.request.contextPath}/master/AggiungiOggettoServlet" method="post">
				<div class="formGroup">
				...
				<div class="formGroup">
					<label for="classeArmatura">Classe Armatura:</label> <input type="number" id="classeArmatura"
						name="classeArmatura" required>
				</div>

				<div>
					<label for="tipologia">Seleziona Tipologia:</label> <select
						id="tipologia" name="tipologia" required>
						<%
						List<Tipologia> listaTipologie = (List<Tipologia>) request.getAttribute("listaTipologie");
				...
				<div>
					...
					%>
					<input type="checkbox" name="professioni"
						value="<%=professione.getId()%>">
					<%=professione.getNome()%><br>
					<%
					}
					}
					%>
				...
				<div class="formGroup">
					<button type="submit" class="btnAdd">Aggiungi Oggetti</button>
				</div>
			</form>
		</div>
	</div>
