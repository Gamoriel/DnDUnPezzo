...
<body>
	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<form action="${pageContext.request.contextPath}/master/AggiungiQualitaServlet" method="post">
				<div>
					<label for="nome">Nome Qualità:</label> <input type="text"
						id="nome" name="nome" required>
				</div>
				<div class="formGroup">
					<button type="submit" class="btnAdd">Aggiungi Qualita</button>
				</div>
			</form>
		</div>
	</div>
