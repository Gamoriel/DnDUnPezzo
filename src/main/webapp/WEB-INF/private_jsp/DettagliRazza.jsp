	...
	<div class="container">
		...
		<div class="centerBar">
			...
			<div class="actionButtons">
				<form action="${pageContext.request.contextPath}/master/ModificaRazzaServlet" method="get">
					<input type="hidden" name="idRazza"
						value="<%=razza != null ? razza.getId() : ""%>">
					<button type="submit" class="buttonMod">Modifica Razza</button>
				</form>

				<form action="${pageContext.request.contextPath}/master/EliminaRazzaServlet" method="post">
					<input type="hidden" name="idRazza"
						value="<%=razza != null ? razza.getId() : ""%>">
					<button type="submit" class="buttonDel"
						onclick="return confirm('Sei sicuro di voler eliminare questa razza?');">Elimina
						Razza</button>
				</form>
			</div>
		</div>
