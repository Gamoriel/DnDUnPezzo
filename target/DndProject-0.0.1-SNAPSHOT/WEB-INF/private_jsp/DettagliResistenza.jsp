...
<body>
    ...
    <div class="container">
        ...
        <div class="dettagliResistenza">
            <%
            Resistenza resistenza = (Resistenza) request.getAttribute("resistenza");
            if (resistenza != null) {
            %>
            <h1>Dettagli Resistenza: <%= resistenza.getNome() %></h1>
            <p><strong>Descrizione:</strong> <%= resistenza.getDescrizione() %></p>
            ...
            <div class="actions">
                ...
                <form action="EliminaResistenzaServlet" method="post">
                    <input type="hidden" name="idResistenza" value="<%= resistenza.getId() %>">
                    <button type="submit" class="buttonDel" onclick="return confirm('Sei sicuro di voler eliminare questa resistenza?')">Elimina</button>
                </form>
            </div>
            <%
            } else {
