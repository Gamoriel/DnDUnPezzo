...
<body>
    ...
    <div class="container">
        ...
        <div class="centerBar">
            ...
            <form action="AggiungiNaveServlet" method="post">
                <div>
                ...
                <div>
                    <label for="ciurma">Seleziona Ciurma:</label>
                    <select id="ciurma" name="ciurma" required>
                        <%
                ...
                <div>
                    <input type="submit" value="Aggiungi Nave">
                </div>
            </form>
        </div>
    </div>
